      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <p>
              Let&apos;s make cool things, for cool people.
            </p>
            <p>
            ...
            <p>
              Today, I’m exploring web development, artificial intelligence, and content and technical writing.
            </p>
          </div>
        </div>
        <div className="lg:pl-20">
          <ul role="list">
            ...
            <SocialLink href="https://www.linkedin.com/in/tony-geiser/" icon={LinkedInIcon} className="mt-4">
              Follow on LinkedIn
            </SocialLink>
            <SocialLink
              href="mailto:geisera@gmail.com"
              icon={MailIcon}
