...
function Resume() {
  let resume = [
    ...
    {
      company: 'CTI Professional Flight Training',
...
function Photos() {
  let rotations = ['rotate-0', '-rotate-0', 'rotate-0', 'rotate-2', '-rotate-2']

  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[atWork, doMore, family,].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Weeb Developer, Salesforce Consultant, and Technical Writer.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            It&apos;s not enough to be a good coder anymore.
          </p>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            It&apos;s time to stop learning new frameworks, new stacks, new platforms. It&apos;s time to start building.
          </p>
          <div className="mt-6 flex gap-6">
            ...
            /> */}
            <SocialLink
              href="https://www.linkedin.com/in/tony-geiser/"
